  ...
  return (
    <div className="mt-3 mb-3 p-5">
      <div>
        ...
        <p>
          The information provided by Right Group Multipurpose Investment
          Company Pvt. Ltd.("Company", "we", "our", "us") on www.ticketgooo.com
        ...
        <p>
          ...
          contained in this site has been obtained from reliable sources, Right
          Group Multipurpose Investment Company Pvt. Ltd.is not responsible for
          any errors or omissions or for the results obtained from the use of
          this information. All information in this site is provided "as is",
        ...
        <p>
          In no event will Table Able Solution Pvt. Ltd., its related
        ...
        <p>
          ...
          www.ticketgooo.com are the trademarks and logos of their respective
          owners. Any inclusion of such trademarks or logos does not imply or
          constitute any approval, endorsement or sponsorship of Right Group
          Multipurpose Investment Company Pvt. Ltd.by such owners.
        </p>
        ...
        <p>
          ...
          or other inquiries, please contact us by email: help@ticketgooo.com.
        </p>
      </div>
    </div>
  );
