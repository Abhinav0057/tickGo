...
const CreateEvent = () => {
  const { mutateAsync, error, mutate, isLoading, isSuccess } = usePostAEvent();
  ...
  const onSubmit2 = async (data) => {
    ...
    const payload = {
      ...
      venue: {
        name: beforeFormData?.eventLocation,
        coordinates: {
          lat: "12",
          lng: "1234",
        },
      ...
      recurring: beforeFormData?.evenrRecurring ?? 0,
    ...
    for (const image of beforeFormData?.eventImages) {
                  ...
                  <div className="mb-3 ">
                    <Form.Group className="mb-3 " controlId="">
                      <Form.Select
                        ...
                        className="me-2"
                        // defaultValue={
                        //   categoriesData?.data ? categoriesData?.data[1]?.id : ""
                        // }
                        style={{
                ...
                <div>
                  ...
                  <Form.Group className="mb-3" controlId="">
                    ...
                    <Form.Control
                      ...
                      placeholder=""
                      style={{
                        border: errors1.eventLocationLink
                          ? "1px solid red"
                          : "",
                      }}
